...
using Backend.IdentityServer.Domain.Shared.ApiResources;
...
public static class IdentityServerDbContextModelCreatingExtensions
{
        ...
        this ModelBuilder builder)
    {
        ...
        {
            b.ToTable(IdentityServerDbProperties.DbTablePrefix + "Clients", IdentityServerDbProperties.DbSchema);
            ...
            b.Property(x => x.AllowedIdentityTokenSigningAlgorithms)
                .HasMaxLength(ClientConsts.AllowedIdentityTokenSigningAlgorithms);
        ...
        {
            b.ToTable(IdentityServerDbProperties.DbTablePrefix + "ClientGrantTypes",
                IdentityServerDbProperties.DbSchema);
        ...
        {
            b.ToTable(IdentityServerDbProperties.DbTablePrefix + "ClientRedirectUris",
                IdentityServerDbProperties.DbSchema);
        ...
        {
            b.ToTable(IdentityServerDbProperties.DbTablePrefix + "ClientPostLogoutRedirectUris",
                IdentityServerDbProperties.DbSchema);
        ...
        {
            b.ToTable(IdentityServerDbProperties.DbTablePrefix + "ClientScopes", IdentityServerDbProperties.DbSchema);
        ...
        {
            b.ToTable(IdentityServerDbProperties.DbTablePrefix + "ClientSecrets", IdentityServerDbProperties.DbSchema);
        ...
        {
            b.ToTable(IdentityServerDbProperties.DbTablePrefix + "ClientClaims", IdentityServerDbProperties.DbSchema);
        ...
        {
            b.ToTable(IdentityServerDbProperties.DbTablePrefix + "ClientIdPRestrictions",
                IdentityServerDbProperties.DbSchema);
        ...
        {
            b.ToTable(IdentityServerDbProperties.DbTablePrefix + "ClientCorsOrigins",
                IdentityServerDbProperties.DbSchema);
        ...
        {
            b.ToTable(IdentityServerDbProperties.DbTablePrefix + "ClientProperties",
                IdentityServerDbProperties.DbSchema);
        ...
        {
            b.ToTable(IdentityServerDbProperties.DbTablePrefix + "IdentityResources",
                IdentityServerDbProperties.DbSchema);
        ...
        {
            b.ToTable(IdentityServerDbProperties.DbTablePrefix + "IdentityResourceClaims",
                IdentityServerDbProperties.DbSchema);
        ...
        {
            b.ToTable(IdentityServerDbProperties.DbTablePrefix + "IdentityResourceProperties",
                IdentityServerDbProperties.DbSchema);
        ...
        {
            b.ToTable(IdentityServerDbProperties.DbTablePrefix + "ApiResources", IdentityServerDbProperties.DbSchema);
            ...
            b.Property(x => x.AllowedAccessTokenSigningAlgorithms)
                .HasMaxLength(ApiResourceConsts.AllowedAccessTokenSigningAlgorithmsMaxLength);
        ...
        {
            b.ToTable(IdentityServerDbProperties.DbTablePrefix + "ApiResourceSecrets",
                IdentityServerDbProperties.DbSchema);
        ...
        {
            b.ToTable(IdentityServerDbProperties.DbTablePrefix + "ApiResourceClaims",
                IdentityServerDbProperties.DbSchema);
        ...
        {
            b.ToTable(IdentityServerDbProperties.DbTablePrefix + "ApiResourceScopes",
                IdentityServerDbProperties.DbSchema);
        ...
        {
            b.ToTable(IdentityServerDbProperties.DbTablePrefix + "ApiResourceProperties",
                IdentityServerDbProperties.DbSchema);
        ...
        {
            b.ToTable(IdentityServerDbProperties.DbTablePrefix + "ApiScopes", IdentityServerDbProperties.DbSchema);
        ...
        {
            b.ToTable(IdentityServerDbProperties.DbTablePrefix + "ApiScopeClaims", IdentityServerDbProperties.DbSchema);
        ...
        {
            b.ToTable(IdentityServerDbProperties.DbTablePrefix + "ApiScopeProperties",
                IdentityServerDbProperties.DbSchema);
        ...
        {
            b.ToTable(IdentityServerDbProperties.DbTablePrefix + "PersistedGrants",
                IdentityServerDbProperties.DbSchema);
            ...
            if (IsDatabaseProvider(builder, EfCoreDatabaseProvider.MySql))
            {
                PersistedGrantConsts.DataMaxLengthValue =
                    10000; //TODO: MySQL accepts 20.000. We can consider to change in v3.0.
            }
        ...
        {
            b.ToTable(IdentityServerDbProperties.DbTablePrefix + "DeviceFlowCodes",
                IdentityServerDbProperties.DbSchema);
            ...
            if (IsDatabaseProvider(builder, EfCoreDatabaseProvider.MySql))
            {
                DeviceFlowCodesConsts.DataMaxLength =
                    10000; //TODO: MySQL accepts 20.000. We can consider to change in v3.0.
            }
