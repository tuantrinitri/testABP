...
public class ResourceStore : IResourceStore
{
    ...
    public ResourceStore(
        ...
        IObjectMapper<IdentityServerDomainModule> objectMapper,
    ...
    public virtual async Task<IdentityServer4.Models.Resources> GetAllResourcesAsync()
    {
        return await ResourcesCache.GetOrAddAsync(AllResourcesKey, async () =>
        {
            ...
            return new Resources(
                ObjectMapper.Map<List<IdentityResource>, List<IdentityServer4.Models.IdentityResource>>(identityResources),
                ObjectMapper.Map<List<ApiResource>, List<IdentityServer4.Models.ApiResource>>(apiResources),
                ObjectMapper.Map<List<ApiScope>, List<IdentityServer4.Models.ApiScope>>(apiScopes));
