...
public class OrganizationUnitManager_Tests : IdentityDomainTestBase
{
    ...
    {
        await _organizationUnitManager.CreateAsync(new OrganizationUnit(_guidGenerator.Create(), "Root 1", null));
