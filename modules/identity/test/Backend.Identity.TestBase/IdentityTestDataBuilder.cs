...
public class IdentityTestDataBuilder : ITransientDependency
{
    ...
    public IdentityTestDataBuilder(
    ...
    private async Task AddOrganizationUnits()
    {
        ...
        _ou111 = new OrganizationUnit(_guidGenerator.Create(), "OU111", ou11.CodeName, ou11.Id);
    ...
    private async Task AddUsers()
    {
        ...
        await _profileRepository.InsertAsync(johnProfile);
    ...
    private async Task<OrganizationUnit> CreateOU(string displayName, string code, Guid? parentId = null, string codeName = null)
    {
        var ou = await _organizationUnitRepository.InsertAsync(new OrganizationUnit(_guidGenerator.Create(), displayName, codeName, parentId) { Code = code });
        return ou;
    }
