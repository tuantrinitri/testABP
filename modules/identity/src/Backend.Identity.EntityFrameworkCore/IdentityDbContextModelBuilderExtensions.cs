...
public static class IdentityDbContextModelBuilderExtensions
{
    public static void ConfigureIdentity([NotNull] this ModelBuilder builder)
    {
        ...
        {
            b.ToTable(IdentityDbProperties.DbTablePrefix + "Users", IdentityDbProperties.DbSchema);
        ...
        {
            b.ToTable(IdentityDbProperties.DbTablePrefix + "UserClaims", IdentityDbProperties.DbSchema);
        ...
        {
            b.ToTable(IdentityDbProperties.DbTablePrefix + "UserRoles", IdentityDbProperties.DbSchema);
        ...
        {
            b.ToTable(IdentityDbProperties.DbTablePrefix + "UserLogins", IdentityDbProperties.DbSchema);
        ...
        {
            b.ToTable(IdentityDbProperties.DbTablePrefix + "UserTokens", IdentityDbProperties.DbSchema);
        ...
        {
            b.ToTable(IdentityDbProperties.DbTablePrefix + "Roles", IdentityDbProperties.DbSchema);
        ...
        {
            b.ToTable(IdentityDbProperties.DbTablePrefix + "RoleClaims", IdentityDbProperties.DbSchema);
        ...
        if (builder.IsHostDatabase())
        {
            ...
            {
                b.ToTable(IdentityDbProperties.DbTablePrefix + "ClaimTypes", IdentityDbProperties.DbSchema);
        ...
        {
            b.ToTable(IdentityDbProperties.DbTablePrefix + "OrganizationUnits", IdentityDbProperties.DbSchema);
        ...
        {
            b.ToTable(IdentityDbProperties.DbTablePrefix + "OrganizationUnitRoles", IdentityDbProperties.DbSchema);
            ...
            b.HasIndex(ou => new {ou.OrganizationUnitId, ou.RoleId});
        ...
        {
            b.ToTable(IdentityDbProperties.DbTablePrefix + "UserOrganizationUnits", IdentityDbProperties.DbSchema);
            ...
            b.HasIndex(ou => new {ou.OrganizationUnitId, ou.UserId});
        ...
        {
            b.ToTable(IdentityDbProperties.DbTablePrefix + "SecurityLogs", IdentityDbProperties.DbSchema);
        ...
        {
            b.ToTable(IdentityDbProperties.DbTablePrefix + "UserProfiles", IdentityDbProperties.DbSchema);

            b.ConfigureByConvention();

            //b.HasOne<UserProfile>().WithOne().HasForeignKey<IdentityUser>(x => x.Id);

            b.Property(x => x.SoldierCode).HasMaxLength(IdentityUserConsts.MaxNameLength);
        });
        ...
        if (builder.IsHostDatabase())
        {
            ...
            {
                b.ToTable(IdentityDbProperties.DbTablePrefix + "LinkUsers", IdentityDbProperties.DbSchema);
        ...
        {
            b.ToTable(IdentityDbProperties.DbTablePrefix + "UserDelegations", IdentityDbProperties.DbSchema);
