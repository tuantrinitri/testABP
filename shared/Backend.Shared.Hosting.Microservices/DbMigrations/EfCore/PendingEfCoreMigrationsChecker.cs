...
namespace Backend.Shared.Hosting.Microservices.DbMigrations.EfCore;
    ...
    where TDbContext : DbContext
{
    ...
    protected async Task LockAndApplyDatabaseMigrationsAsync()
    {
        ...
        Log.Information("Lock is released for db migration and seeding on database named: {DatabaseName}...", DatabaseName);
    }
}